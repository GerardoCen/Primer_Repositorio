...
<head>
    ...
    <meta name="Ceniceros Maldonado Gerardo" content="">
...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +52 618 308 3740</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i>gera@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright ©️ 2024 E-SHOPPER Inc. Todos los Derechos</p>                    
                </div>
            </div>
        </div>
